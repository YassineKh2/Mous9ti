...
export const SCALES_DATABASE: ScaleDefinition[] = [
  ...
  },
  {
    ...
    intervalsNamed: ["R", "M2", "m3", "P4", "P5", "M6", "m7"],
    cagedBoxes: {
      "Pattern 1 (D Shape)": { startFretOffset: 0, endFretOffset: 3 },
      "Pattern 2 (C Shape)": { startFretOffset: 2, endFretOffset: 5 },
      "Pattern 3 (A Shape)": { startFretOffset: 5, endFretOffset: 8 },
      "Pattern 4 (G Shape)": { startFretOffset: 7, endFretOffset: 10 },
  ...
  },
  {
    ...
    cagedBoxes: {
      ...
      "Pattern 2 (A Shape)": { startFretOffset: 2, endFretOffset: 5 },
      "Pattern 3 (G Shape)": { startFretOffset: 5, endFretOffset: 8 },
  ...
  },
  {
    ...
    intervalsNamed: ["R", "M2", "M3", "P4", "P5", "M6", "m7"],
    cagedBoxes: {
      "Pattern 1 (G Shape)": { startFretOffset: 0, endFretOffset: 3 },
      "Pattern 2 (E Shape)": { startFretOffset: 2, endFretOffset: 5 },
      "Pattern 3 (D Shape)": { startFretOffset: 5, endFretOffset: 8 },
      "Pattern 4 (C Shape)": { startFretOffset: 7, endFretOffset: 10 },
